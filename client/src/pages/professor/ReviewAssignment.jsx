...
const ReviewAssignment = () => {
  ...
  const handleApprove = async () => {
    if (!window.confirm('Are you sure you want to approve this assignment and forward it to the HOD?')) {
      return
    }
            ...
            <div className="decision-panel-wrapper animate-slide-in-right">
              <div style={{ ...styles.card, ...styles.decisionPanel }} className="decision-panel">
                <div style={styles.decisionHeader}>
                  ...
                  <div>
                    <h3 style={styles.decisionTitle}>Review Decision</h3>
                    <p style={{ fontSize: '0.75rem', color: 'var(--text-tertiary)' }}>Forward to HOD or Reject</p>
                  </div>
                </div>
