...
const Assignments = () => {
  ...
  const fetchAssignments = async () => {
    ...
    try {
      ...
      const response = await api.get(`/api/professor/assignments?${params}`)
  ...
  const filterTabs = [
    ...
    { key: 'PendingProfessor', label: 'Pending', icon: Clock },
    { key: 'ProfessorApproved', label: 'Forwarded', icon: Send },
                ...
                <table style={styles.table}>
                  <thead style={styles.tableHead}>
                    <tr>
                      ...
                      <th style={styles.th} className="hide-mobile">Subject</th>
                      <th style={styles.th} className="hide-mobile">Submitted</th>
