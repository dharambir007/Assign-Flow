      ...
      <div style={styles.pageContainer}>
        ...
        <div style={styles.headerSection} className="header-section">
          <div style={styles.headerContent}>
            ...
            <div>
              <h1 style={styles.headerTitle}>Approval Center</h1>
              <p style={styles.headerSubtitle}>
                {stats.pendingCount > 0 ? `${stats.pendingCount} assignments awaiting approval` : 'All caught up!'}
              </p>
            </div>
          </div>
          {stats.pendingCount > 0 && (
            <Link
              to="/hod/assignments?status=pending"
        ...
        <div style={styles.assignmentsCard} className="assignments-card">
          <div style={styles.assignmentsHeader}>
            <h2 style={styles.assignmentsTitle}>Awaiting Your Approval</h2>
            <Link to="/hod/assignments" style={styles.viewAllLink} className="view-all-link">
              View all
            </Link>
          </div>
                ...
                >
                  <div style={styles.assignmentInfo}>
                    ...
                    <p style={styles.assignmentMeta}>
                      {assignment.studentEmail} • Verified by {assignment.professorReviewedBy?.name || 'Professor'}
                    </p>
                  </div>
