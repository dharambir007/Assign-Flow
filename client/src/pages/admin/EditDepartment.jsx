...
const EditDepartment = () => {
  ...
  const fetchDepartment = async () => {
    try {
      ...
      setError('Failed to load unit configuration.')
    } finally {
      setLoading(false)
    }
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.response?.data?.message || 'Update failed. Registry conflict possible.')
    } finally {
      setSubmitting(false)
    }
  }
    ...
    return (
      <Layout title="Hierarchy Administration">
        ...
        <div style={styles.loadingContainer}>
          ...
          <p style={styles.loadingText}>Synchronizing unit data...</p>
        </div>
      </Layout>
    )
  }
        ...
        <div style={styles.formCard} className="form-card">
          ...
          <div style={styles.cardHeader} className="card-header">
            ...
            <div style={styles.headerContent}>
              ...
              <div>
                <h2 style={styles.headerTitle}>Edit Department</h2>
                <p style={styles.headerSubtitle}>Modify organizational unit details</p>
              </div>
            </div>
          </div>
