...
const EditUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.response?.data?.message || 'Update failed. Please retry later.')
    } finally {
      setSubmitting(false)
    }
  }
    ...
    return (
      <Layout title="Membership Control">
        ...
        <div style={styles.loadingContainer}>
          ...
          <p style={styles.loadingText}>Retrieving profile data...</p>
        </div>
      </Layout>
    )
  }
        ...
        <div style={styles.formCard} className="form-card">
          ...
          <div style={styles.cardHeader} className="card-header">
            ...
            <div style={styles.headerContent}>
              ...
              <div>
                <h2 style={styles.headerTitle}>Edit User Profile</h2>
                <p style={styles.headerSubtitle}>Modify member access or contact details</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit}>
              <div style={styles.formGrid}>
                ...
                <div style={styles.formGroup} className="form-group">
                  ...
                  <p style={styles.helperText}>Leave empty to keep current password</p>
                </div>
